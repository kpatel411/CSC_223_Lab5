...
class JSONParserTest {
	...
	public static ComponentNode runFigureParseTestGeometry(String filename)
	{
		JSONParser parser = new JSONParser(new GeometryBuilder()); //was geometry builder -> do one for each builder for each file 
	...
	void single_triangle_testG()
	{
		...
		sb = (StringBuilder) unparser.visitFigureNode((FigureNode) node, new AbstractMap.SimpleEntry<StringBuilder, Integer>(sb, 0));
